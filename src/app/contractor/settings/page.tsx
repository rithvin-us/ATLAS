      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <Label>RFQ Alerts</Label>
                <p className="text-sm text-muted-foreground">
                  Alerts for new RFQs matching your profile
                </p>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <Label>Auction Notifications</Label>
                <p className="text-sm text-muted-foreground">
                  Alerts for auction opportunities and results
                </p>
              </div>
              <Switch
                checked={auctionNotifications}
                onCheckedChange={(checked) => handleNotificationChange('auction', checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  Alerts for project milestones and changes
                </p>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  Alerts for invoice approvals and payments
                </p>
              </div>
              <Switch
